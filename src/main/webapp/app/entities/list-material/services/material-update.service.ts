...
import { ListMaterialService, RawGraphQLMaterial } from './list-material.service';
import { ListMaterialUpdateDialogComponent, MaterialItem } from '../dialog/list-material-update-dialog';
...
export class MaterialUpdateService {
  ...
  openEditSelectedDialog(
    ...
    | MatDialogRef<ListMaterialUpdateDialogComponent, { updatedItems: MaterialItem[]; selectedWarehouse: any; approvers: string[] }>
    | undefined {
